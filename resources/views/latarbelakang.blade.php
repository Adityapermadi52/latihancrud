    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-has-children"><a href="https://www.pom.go.id/new/">website BPOM</a>
            </li>
    ...
    <section id="get-started" class="padd-section text-center">
      ...
      <div class="container" data-aos="fade-up">
        <div class="section-title text-center">
          ...
          <p align="justify">Sesuai dengan Peraturan Kepala Badan POM Nomor 12 Tahun 2018 tentang Organisasi dan Tata Kerja Unit Pelaksana Teknis di Lingkungan Badan Pengawas Obat dan Makanan, maka dibentuklah Loka POM di wilayah Kabupaten/Kota di Indonesia, salah satunya di Kabupaten Buleleng. Sejak pembentukan tersebut, Loka POM di Kabupaten Buleleng secara mandiri melaksanakan tugas teknis operasional dan tugas penunjang di bidang pengawasan obat dan makanan. Dalam melaksanakan tugas tersebut, Loka POM di Kabupaten Buleleng menyelenggarakan fungsi pemeriksaan sarana produksi dan distribusi Obat dan Makanan, sertifikasi produk dan sarana produksi dan/atau distribusi Obat dan Makanan, pengambilan contoh (sampling) Obat dan Makanan, pengujian produk, intelijen dan penyidikan terhadap pelanggaran ketentuan peraturan perundang–undangan serta komunikasi, informasi, edukasi, dan pengaduan masyarakat di bidang pengawasan Obat dan Makanan. Dengan cakupan wilayah kerja meliputi wilayah administratif Kabupaten Buleleng dan Kabupaten Jembrana, Loka POM di Kabupaten Buleleng secara aktif menyelenggarakan tugas dan fungsi pengawasan obat dan makanan untuk melindungi masyarakat dari produk ilegal dan/atau mengandung bahan berbahaya serta membentuk konsumen yang cerdas dalam memilih produk obat dan makanan. Pelaksanaan tugas dan fungsi oleh Loka POM di Kabupaten Buleleng tersebut merupakan aksi nyata yang dilakukan oleh Badan POM dalam menghadapi tantangan serta mengawasi peredaran obat dan makanan yang ada di wilayah Kabupaten/Kota.
            Sinergitas yang efektif dan efisien dari 3 (tiga) unsur pengawas dalam Sistem Pengawasan Obat dan Makanan (SisPOM) yakni Pemerintah, Pelaku Usaha dan konsumen (masyarakat) juga diperlukan untuk mendeteksi, mencegah dan mengawasi produk obat dan makanan untuk melindungi keamanan, keselamatan dan kesehatan konsumennya baik di dalam maupun di luar negeri. Untuk itu BPOM menjadi salah satu institusi dari unsur pengawas pemerintah yang berperan aktif dalam menyelenggarakan pengawasan di bidang obat dan makanan yang memiliki jaringan nasional dan internasional serta kewenangan penegakan hukum dan memiliki kredibilitas profesional yang tinggi. Setelah aktif membangun relasi dan koordinasi sejak tahun 2018 sebagai Unit Pelaksana Teknis (UPT) Badan POM di tingkat Wilayah Kabupaten/Kota, Loka POM di Kabupaten Buleleng senantiasa menjalin hubungan kerjasama yang erat dengan lintas sektor terkait, pelaku usaha dan konsumen (masyarakat) selama tahun 2019</p>
