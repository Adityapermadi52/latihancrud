    ...
    <section id="get-started" class="padd-section text-center">
      ...
      <div class="container" data-aos="fade-up">
        <div class="section-title text-center">
          ...
          <h2>Tugas Utama BPOM</h2>
          <p class="separator">Berdasarkan pasal 2 pada Peraturan Presiden Nomor 80 Tahun 2017 tentang Badan Pengawas Obat dan Makanan:</p>
          ...
          <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="feature-block">
               <h2>Tugas Utama BPOM</h2>
                <p class="separator">LOKA POM DI KABUPATEN BULELENG</p>
              <p>BPOM mempunyai tugas menyelenggarakan tugas pemerintahan di bidang pengawasan Obat dan Makanan sesuai dengan ketentuan peraturan perundang-undangan.</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="300">
             <div class="feature-block">
               <h2>Tugas Utama BPOM</h2>
                <p class="separator">LOKA POM DI KABUPATEN BULELENG</p>
              <p>Obat dan Makanan sebagaimana dimaksud pada ayat (1) terdiri atas obat, bahan obat, narkotika, psikotropika, prekursor, zat adiktif, obat tradisional, suplemen kesehatan, kosmetik, dan pangan olahan.</p>
            </div>
          </div>
        ...
        <div class="section-title text-center">
          ...
          <h2>Tugas Loka POM  Buleleng</h2>
          <p>Berdasarkan Pasal 3 Peraturan BPOM Nomor 12 Tahun 2018, UPT BPOM mempunyai tugas melaksanakan tugas teknis
              operasional di bidang pengawasan Obat dan Makanan pada
              wilayah kerja masing-masing sesuai dengan ketentuan
      ...
      <div class="container" data-aos="fade-up">
        <div class="section-title text-center">
          ...
          <h2>Fungsi Utama BPOM</h2>
          <p class="separator">Berdasarkan pasal 4 pada Peraturan Presiden Nomor 80 Tahun 2017 tentang Badan Pengawas Obat dan Makanan, BPOM mempunyai fungsi: Dalam melaksanakan tugas pengawasan Obat dan Makanan, BPOM menyelenggarakan fungsi</p>
      ...
      <div class="container">
        ...
        <div class=" container col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="feature-block">
              <h4>A</h4>
              <p>Penyusunan rencana, program, dan anggaran di bidang pengawasan Obat dan Makanan.</p>
            </div>
          </div>
           ...
           <div class=" container col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="feature-block">
              <h4>B</h4>
              <p>Pelaksanaan pemeriksaan fasilitas produksi Obat dan Makanan</p>
            </div>
          </div>
            ...
            <div class="feature-block">
              <h4>C</h4>
              <p>Pelaksanaan pemeriksaan fasilitas distribusi Obat dan Makanan dan fasilitas pelayanan kefarmasian.</p>
            </div>
          </div>
            ...
            <div class="feature-block">
              <h4>D</h4>
              <p>Pelaksanaan sertifikasi produk dan fasilitas produksi dan distribusi Obat dan Makanan.</p>
            </div>
          </div>
            ...
            <div class="feature-block">
              <h4>E</h4>
              <p>Pelaksanaan sampling Obat dan Makanan.</p>
            </div>
          </div>
           ...
           <div class=" container col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="feature-block">
              <h4>F</h4>
              <p>Pelaksanaan pemantauan label dan iklan Obat dan Makanan</p>
            </div>
          </div>
           ...
           <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="300">
            <div class="feature-block">
              <h4>G</h4>
              <p>Pelaksanaan pengujian rutin Obat dan Makanan</p>
            </div>
          </div>
            <div class=" container col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="feature-block">
              <h4>H</h4>
              <p>Pelaksanaan pengujian Obat dan Makanan dalam rangka investigasi dan penyidikan</p>
            </div>
          </div>
      ...
      <div class=" container col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="feature-block">
              <h4>I</h4>
              <p>Pelaksanaan cegah tangkal, intelijen dan penyidikan terhadap pelanggaran ketentuan peraturan perundangundangan di bidang pengawasan Obat dan Makanan.</p>
            </div>
          </div>
           ...
           <div class=" container col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="feature-block">
              <h4>J</h4>
              <p>Pelaksanaan pemantauan peredaran Obat dan Makanan melalui siber.</p>
            </div>
          </div>
           ...
           <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="300">
            <div class="feature-block">
              <h4>K</h4>
              <p>Pengelolaan komunikasi, informasi, edukasi, dan pengaduan masyarakat di bidang pengawasan Obat dan Makanan.</p>
            </div>
          </div>
          <div class=" container col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="feature-block">
              <h4>L</h4>
              <p>Pelaksanaan kerja sama di bidang pengawasan Obat dan Makanan</p>
            </div>
          </div>
               <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="feature-block">
              <h4>M</h4>
              <p>Pelaksanaan pemantauan, evaluasi, dan pelaporan di bidang pengawasan Obat dan Makanan.</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="300">
            ...
            <div class="feature-block">
              <h4>O</h4>
              <p>Pelaksanaan fungsi lain yang diberikan oleh Kepala Badan.</p>
            </div>
          </div>
  ...
  <footer class="footer">
    ...
    <div class="copyrights">
      <div class="container">
        ...
        -->
          Designed by <a href="https://www.instagram.com/p/CPFvfYaBZ79/?utm_medium=share_sheet">Aditya Permadi & Krisna</a>
        </div>
      </div>
    </div>
  </footer><!-- End  Footer -->
